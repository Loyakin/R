...
/* main: prende come argomenti l'hostname e la porta su cui connettersi
 */
int main(int argc, char *argv[]) {
	...
	/* apertura socket con controllo corretta apertura di questa, le cose in maiuscolo sono le famiglie delle socket*/
	portno = atoi(argv[2]);	
